...
## Current Status: 🟢 v3.8.4 — second Obsidian directory review pass fixed (latex-modal.ts positioning + settings heading); shipped, resubmission pending live confirmation
